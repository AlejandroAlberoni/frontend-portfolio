  ...
  return (
    <div className='flex flex-col my-8 md:my-[10vh]'>
      <div className='grid place-items-center gap-y-2'>
        ...
        <h2 className='font-lexendexa text-[15px] md:text-[25px] font-semibold m-4'>Social media</h2>
        <div className='flex justify-center space-x-4'>
          ...
          <a href='https://www.instagram.com/atralberoni/' target='_blank' ><Image className='transition ease-in-out duration-300 hover:bg-blue-500 rounded-[6px]' src={'/logotipo-do-instagram.png'} alt={'Instagram social media'} width={20} height={20}></Image></a>
        </div>
      </div>
